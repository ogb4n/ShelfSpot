...
INSERT INTO "new_Item" ("consumable", "id", "image", "name", "placeId", "price", "quantity", "roomId", "sellprice", "status", "tags") SELECT "consumable", "id", "image", "name", "placeId", "price", "quantity", "roomId", "sellprice", "status", "tags" FROM "Item";
DROP TABLE "Item";
