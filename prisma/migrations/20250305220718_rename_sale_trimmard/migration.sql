/*
  ...
  - You are about to drop the column `descritpion` on the `Income` table. All the data in the column will be lost.
  - You are about to drop the column `descritpion` on the `Outcome` table. All the data in the column will be lost.
  ...
  - Added the required column `description` to the `Outcome` table without a default value. This is not possible if the table is not empty.
