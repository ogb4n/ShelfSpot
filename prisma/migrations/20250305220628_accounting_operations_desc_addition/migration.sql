/*
  ...
  - Added the required column `descritpion` to the `Income` table without a default value. This is not possible if the table is not empty.
  - Added the required column `descritpion` to the `Outcome` table without a default value. This is not possible if the table is not empty.
